...
export default function Header() {
  ...
  useEffect(() => {
    if (pastHeroButton && isDesktop) {
      paddingY.set(6);
      scale.set(0.94);
    } else if (!isDesktop) { // Fixed typo: replaced "अगर" with "if"
      paddingY.set(12);
      scale.set(1);
    }
  ...
  return (
    <>
      ...
      >
        ...
        <motion.nav
          className={`hidden md:flex items-center ${pastHeroButton ? 'justify-between' : 'justify-center'} w-full`}
